...
> Build a feature using docs as source of truth
...
*Auto-generated from [`.claude/commands/develop-feature.md`](https://github.com/quochuydev/workflow/blob/main/.claude/commands/develop-feature.md)*
