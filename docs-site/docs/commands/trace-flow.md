...
> Trace code flow with business context from docs
...
|----------|-------------|----------|
| `target` | Function name, endpoint, or file to trace from | Yes |
...
*Auto-generated from [`.claude/commands/trace-flow.md`](https://github.com/quochuydev/workflow/blob/main/.claude/commands/trace-flow.md)*
